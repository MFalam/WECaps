...
class EGWEmbedding(nn.Module):
    ...
    def __init__(self, num1: int, num2: int, dim: int, cost_type: str = 'cosine', loss_type: str = 'L2'):
        super(EGWEmbedding, self).__init__()
        self.num1 = num1
        self.num2 = num2
        self.dim = dim
...
class EGWLearning(object):
    """
    Learning EGW distance in a nonparametric way.
    """
    def __init__(self, hyperpara_dict):
        ...
        self.gwl_model = EGWEmbedding(self.src_num, self.tar_num, self.dim, self.loss_type)
        self.d_gw = []
    ...
    def regularized_EGW(self, cost_s, cost_t, cost_mutual, mu_s, mu_t, hyperpara_dict):
        ...
        for epoch in range(hyperpara_dict['epochs']):
            ...
            for src_idx, indices1 in enumerate(src_loader):
                for tar_idx, indices2 in enumerate(tar_loader):
                    # Estimate EGW discrepancy give current costs
                    ...
                    trans, d_gw, cost_12 = self.regularized_EGW_discrepancy(cost1, cost2, cost12,
